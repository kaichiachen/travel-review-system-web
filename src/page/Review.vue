...
<div class="reviewContainer">
    ...
    <md-dialog md-open-from="#custom" md-close-to="#custom" ref="dialog">
      <md-dialog-content class='dialogcontent'>
        <reviewdetail ref="reviewdetail" v-on:closeDialog="reviewEventEmitted" v-if="this.type==='reviewdetail'"></reviewdetail>
        <reviewpost ref="reviewpost" v-on:closeDialog="reviewEventEmitted" v-if="this.type==='reviewpost'"></reviewpost>
      </md-dialog-content>
    </md-dialog>
</div>
</template>
...
import { reviewPostListReq } from '@/service';
...
export default {
  ...
  methods: {
    ...
    reviewpost(index) {
      ...
      this.$refs.reviewpost.reviewinfo = this.allreviews[index];
      this.$refs.dialog.open();
    },
    reviewEventEmitted(status) {
      if (status === 'accepted') {
